    ...
    <div class="max-w-5xl mx-auto bg-white rounded-md shadow">
        ...
        <div class="bg-white rounded-t-md px-6 py-4 flex justify-between items-center border-b">
            <div class="flex items-center">
                ...
                <h2 class="text-xl font-medium text-gray-800">Edit Pemeriksaan Fisik</h2>
            </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('pemeriksaan_fisik.update', $pemeriksaanFisik->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-lg p-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            <!-- ID Pemeriksaan (Read Only) -->
                            <div>
                                <label for="id" class="block text-sm font-medium text-gray-700 mb-1">ID Pemeriksaan</label>
                                <div class="relative">
                                    ...
                                    <input type="text" id="id" value="{{ $pemeriksaanFisik->id }}" readonly
                                        class="pl-10 block w-full border border-gray-300 bg-gray-100 text-gray-700 rounded-md h-10 cursor-not-allowed">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" id="tanggal_pemeriksaan" name="tanggal_pemeriksaan" value="{{ old('tanggal_pemeriksaan', $pemeriksaanFisik->tanggal_pemeriksaan->format('Y-m-d')) }}" required
                    ...
                    <div class="bg-green-50 border border-green-100 rounded-lg p-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.1" min="0" max="300" id="tinggi_badan" name="tinggi_badan" value="{{ old('tinggi_badan', $pemeriksaanFisik->tinggi_badan) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.1" min="0" max="500" id="berat_badan" name="berat_badan" value="{{ old('berat_badan', $pemeriksaanFisik->berat_badan) }}"
                                        class="pl-10 block w-full border border-gray-300 rounded-md h-10 focus:ring-1 focus:ring-green-500 focus:border-green-500"
                                        placeholder="kg">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.1" min="20" max="45" id="suhu_badan" name="suhu_badan" value="{{ old('suhu_badan', $pemeriksaanFisik->suhu_badan) }}"
                                        class="pl-10 block w-full border border-gray-300 rounded-md h-10 focus:ring-1 focus:ring-green-500 focus:border-green-500"
                                        placeholder="36.5">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="tekanan_darah" name="tekanan_darah" value="{{ old('tekanan_darah', $pemeriksaanFisik->tekanan_darah) }}" maxlength="10"
                                        class="pl-10 block w-full border border-gray-300 rounded-md h-10 focus:ring-1 focus:ring-green-500 focus:border-green-500"
                                        placeholder="120/80">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        ...
                        <div class="mt-5 bg-white rounded-lg p-4 border border-green-200">
                            ...
                            <div class="flex items-center">
                                ...
                                <div id="bmi_result" class="text-sm text-gray-600">
                                    @if($pemeriksaanFisik->tinggi_badan && $pemeriksaanFisik->berat_badan)
                                        BMI: {{ number_format($pemeriksaanFisik->bmi, 1) }} ({{ $pemeriksaanFisik->bmi_category }})
                                    @else
                                        BMI akan muncul di sini
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="keluhan" name="keluhan" rows="3"
                                        ...
                                        placeholder="Deskripsikan keluhan yang dirasakan pasien">{{ old('keluhan', $pemeriksaanFisik->keluhan) }}</textarea>
                                </div>
                                @error('keluhan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="hasil_pemeriksaan" name="hasil_pemeriksaan" rows="3"
                                        class="pl-10 block w-full border border-gray-300 rounded-md focus:ring-1 focus:ring-purple-500 focus:border-purple-500"
                                        placeholder="Tuliskan hasil pemeriksaan secara detail">{{ old('hasil_pemeriksaan', $pemeriksaanFisik->hasil_pemeriksaan) }}</textarea>
                                </div>
