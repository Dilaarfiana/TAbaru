    ...
    <div class="max-w-5xl mx-auto bg-white rounded-md shadow">
        ...
        <div class="bg-white rounded-t-md px-6 py-4 flex justify-between items-center border-b">
            <div class="flex items-center">
                ...
                <h2 class="text-xl font-medium text-gray-800">Import Data Siswa</h2>
            </div>
        ...
        <div class="p-6">
                            ...
                            <ul class="text-sm text-red-700 list-disc list-inside">
                                @if($errors->has('import_errors'))
                                    @foreach($errors->get('import_errors') as $error)
                                        <li>{{ $error }}</li>
                                    @endforeach
                                @elseif($errors->has('import_error'))
                                    <li>{{ $errors->first('import_error') }}</li>
                                @else
            ...
            <form action="{{ route('siswa.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">nama_siswa</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">tempat_lahir</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">tanggal_lahir</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">jenis_kelamin</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">tanggal_masuk</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">status_aktif</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <tr>
                                    ...
                                    <td class="px-3 py-2 text-xs text-gray-500">L</td>
                                    <td class="px-3 py-2 text-xs text-gray-500">15-07-2025</td>
                    ...
                    <div class="mt-3 ml-7">
                        <a href="{{ route('siswa.template') }}" class="inline-flex items-center text-xs font-medium text-blue-600 hover:text-blue-800 transition-colors">
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    ...
                    <button type="submit" id="importButton" disabled 
                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-gray-400 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                        </svg>
                        Import Data
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateFileDisplay(file) {
            ...
            if (fileExtension === 'xlsx' || fileExtension === 'xls') {
                ...
                importButton.classList.add('bg-blue-500', 'hover:bg-blue-600');
        ...
        importForm.addEventListener('submit', function() {
            if (fileUpload.files.length > 0) {
                ...
                importButton.classList.remove('hover:bg-blue-600');
            }
        });
    });
</script>
