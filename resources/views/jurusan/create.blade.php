    ...
    <div class="max-w-5xl mx-auto bg-white rounded-md shadow">
        ...
        <div class="bg-white rounded-t-md px-6 py-4 flex justify-between items-center border-b">
            <div class="flex items-center">
                ...
                <h2 class="text-xl font-medium text-gray-800">Tambah Jurusan Baru</h2>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Kode jurusan harus berupa 1 huruf kapital (A-Z). Huruf yang disarankan adalah: <span class="font-mono font-medium">{{ $nextId }}</span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="Kode_Jurusan" name="Kode_Jurusan" value="{{ old('Kode_Jurusan', $nextId) }}" required maxlength="1" style="text-transform:uppercase;"
                                class="pl-10 block w-full border border-gray-300 rounded-md h-10 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 @error('Kode_Jurusan') border-red-300 @enderror">
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Gunakan huruf yang bermakna, misalnya <strong>T</strong> untuk Teknik</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="Nama_Jurusan" name="Nama_Jurusan" value="{{ old('Nama_Jurusan') }}" required maxlength="30" placeholder="Masukkan nama jurusan"
    ...
    <div class="max-w-5xl mx-auto bg-white rounded-md shadow mt-6">
        <div class="px-6 py-4 border-b">
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-medium text-gray-800">Panduan Kode Jurusan</h3>
            </div>
        </div>
        <div class="p-6">
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-5 border border-blue-100">
                ...
                <ul class="space-y-2 text-sm text-gray-700">
                    <li class="flex items-start">
                        ...
                        <span>Gunakan huruf yang bermakna, misalnya <span class="font-medium text-blue-700">T</span> untuk Teknik, <span class="font-medium text-blue-700">S</span> untuk Sains.</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span>Sesuaikan dengan standar yang digunakan di sekolah Anda.</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span>Pastikan kode jurusan konsisten dan tidak berubah setelah dibuat.</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span>Anda dapat menggunakan kode A-Z untuk maksimal 26 jurusan.</span>
                    </li>
                </ul>
                
                <div class="mt-4 bg-white p-3 rounded-md border border-blue-200">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Kode jurusan tidak dapat diubah setelah disimpan dan akan digunakan untuk membuat ID siswa.</p>
                </div>
            </div>
        </div>
    </div>
