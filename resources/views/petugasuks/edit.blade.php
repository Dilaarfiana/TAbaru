...
<div class="p-4 bg-gray-50 min-h-screen">
    ...
    <div class="max-w-5xl mx-auto bg-white rounded-md shadow">
        ...
        <div class="bg-white rounded-t-md px-6 py-4 flex justify-between items-center border-b">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ isset($petugasUKS) ? 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' : 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z' }}" />
                </svg>
                <h2 class="text-xl font-medium text-gray-800">{{ isset($petugasUKS) ? 'Edit Petugas UKS' : 'Tambah Petugas UKS Baru' }}</h2>
            </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ isset($petugasUKS) ? route('petugasuks.update', $petugasUKS->NIP) : route('petugasuks.store') }}" method="POST">
                @csrf
                @if(isset($petugasUKS))
                    @method('PUT')
                @endif
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                        ...
                        <div class="relative">
                            ...
                            @if(isset($petugasUKS))
                                <input type="text" id="NIP" value="{{ $petugasUKS->NIP }}" 
                                    class="pl-10 block w-full border border-gray-300 rounded-md h-10 bg-gray-100 cursor-not-allowed"
                                    readonly>
                                <input type="hidden" name="NIP" value="{{ $petugasUKS->NIP }}">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="nama_petugas_uks" name="nama_petugas_uks" 
                                value="{{ old('nama_petugas_uks', isset($petugasUKS) ? $petugasUKS->nama_petugas_uks : '') }}" 
                                required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select id="level" name="level"
                                ...
                                <option value="petugas" {{ old('level', isset($petugasUKS) ? $petugasUKS->level : 'petugas') == 'petugas' ? 'selected' : '' }}>Petugas</option>
                                <option value="admin" {{ old('level', isset($petugasUKS) ? $petugasUKS->level : '') == 'admin' ? 'selected' : '' }}>Admin</option>
                            </select>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-1">
                            Password <span class="text-red-500">{{ isset($petugasUKS) ? '' : '*' }}</span>
                            @if(isset($petugasUKS))
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                placeholder="{{ isset($petugasUKS) ? 'Masukkan password baru (min. 6 karakter)' : 'Masukkan password (min. 6 karakter)' }}"
                            >
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            {{ isset($petugasUKS) ? 'Kosongkan jika tidak ingin mengubah password' : 'Password minimal 6 karakter' }}
                        </p>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea id="alamat" name="alamat" rows="3" 
                                ...
                                placeholder="Masukkan alamat lengkap">{{ old('alamat', isset($petugasUKS) ? $petugasUKS->alamat : '') }}</textarea>
                        </div>
                        @error('alamat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="no_telp" name="no_telp" 
                                value="{{ old('no_telp', isset($petugasUKS) ? $petugasUKS->no_telp : '') }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select id="status_aktif" name="status_aktif"
                                ...
                                <option value="1" {{ old('status_aktif', isset($petugasUKS) ? $petugasUKS->status_aktif : '1') == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('status_aktif', isset($petugasUKS) ? $petugasUKS->status_aktif : '') == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                <svg class="h-4 w-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc space-y-1 pl-5">
                                    ...
                                    @if(isset($petugasUKS))
                                    <li>Password dapat dikosongkan jika tidak ingin mengubah password lama</li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        {{ isset($petugasUKS) ? 'Simpan Perubahan' : 'Simpan' }}
                    </button>
                </div>
            </form>
        </div>
